...
export const SETUP_LOGIN_HINTS: Record<string, string> = {
  cursor:
    "newagentsetup.general.cursorloginhint",
  gemini_local:
    "newagentsetup.general.geminiloginhint",
  kimi_local:
    "newagentsetup.general.kimiloginhint",
  grok_local:
    "newagentsetup.general.grokloginhint",
  hermes_local:
    "newagentsetup.general.hermesloginhint",
};
