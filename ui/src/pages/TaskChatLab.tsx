  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <header className="border-b border-border px-4 py-2">
        <h1 className="text-sm font-semibold">{t("taskchatlab.general.taskchatlab")}</h1>
        <p className="text-xs text-muted-foreground">
          {t("taskchatlab.general.syntheticharnessforthetaskchatredesign")}</p>
      </header>

      <div className="flex min-h-0 flex-1">
        {/* State switcher */}
        <nav className="w-56 shrink-0 overflow-y-auto border-r border-border p-2" aria-label={t("taskchatlab.general.states")}>
        ...
        <main className="flex min-h-0 flex-1 flex-col">
          <div className="flex items-center gap-3 border-b border-border px-4 py-2 text-xs">
            ...
            >
              ...
              {playing ? t("taskchatlab.general.pause") : t("taskchatlab.general.play")}
            </button>
            <button
              type="button"
            ...
            >
              ...
              {t("taskchatlab.general.replay")}</button>
            <label className="flex items-center gap-2">
              <span className="text-muted-foreground">{t("taskchatlab.general.speed")}</span>
              <input
                type="range"
                min={0.1}
                max={10}
                ...
                aria-label={t("taskchatlab.general.streamingspeed")}
                className="w-32"
              />
              <span className="w-10 tabular-nums">{speed.toFixed(1)}×</span>
            </label>
            <div className="ml-auto flex items-center gap-2">
              <span className="text-muted-foreground">{t("taskchatlab.general.agentbubble")}</span>
              <div className="flex items-center gap-0.5 rounded border border-border p-0.5" role="group" aria-label={t("taskchatlab.general.agentbubbletreatment")}>
