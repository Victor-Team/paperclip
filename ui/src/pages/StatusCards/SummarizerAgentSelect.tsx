...
export function SummarizerAgentSelect({
  ...
  const renderAgent = (option: InlineEntityOption | null) => {
    if (!option || !option.id) return <span>{t("summarizeragentselect.general.summarizerdefault")}</span>;
  ...
  return (
    <InlineEntitySelector
      ...
      placeholder={t("summarizeragentselect.general.summarizerdefault1")}
      noneLabel={t("summarizeragentselect.general.summarizerdefault")}
      searchPlaceholder={t("summarizeragentselect.general.searchagents")}
      emptyMessage={t("summarizeragentselect.general.noagentsfound")}
