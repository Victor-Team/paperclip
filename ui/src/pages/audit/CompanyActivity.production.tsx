...
export function CompanyActivity() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("companyactivityproduction.general.activity") }]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={History} message={t("companyactivityproduction.general.selectacompanytoviewactivity")} />;
  }
