...
export function Issues() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("issues.general.tasks") }]);
  }, [setBreadcrumbs, t]);
    ...
    return (
      <EmptyState
        ...
        message={streamlinedUiEnabled
          ? t("issues.general.selectAnOrganizationToViewTasks")
          : t("issues.general.selectACompanyToViewTasks")}
      />
    );
  }
