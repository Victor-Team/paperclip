  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-(--gtc-39)">
          <div className="p-6 sm:p-7">
            <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/25 bg-cyan-500/[0.08] px-3 py-1 text-(length:--text-nano) font-semibold uppercase tracking-(--tracking-caps) text-cyan-700 dark:text-cyan-300">
              ...
              {t("issuechatuxlab.general.chatuxlab")}</div>
            <h1 className="mt-4 text-3xl font-semibold tracking-tight">{t("issuechatuxlab.general.issuechatreviewsurface")}</h1>
            <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
              {t("issuechatuxlab.general.thispageexercisestherealassistantui")}</p>
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2">
              ...
              <Badge variant="outline" className="rounded-full px-3 py-1 text-(length:--text-nano) uppercase tracking-(--tracking-caps)">
                {t("issuechatuxlab.general.assistantuithread")}</Badge>
              <Badge variant="outline" className="rounded-full px-3 py-1 text-(length:--text-nano) uppercase tracking-(--tracking-caps)">
                {t("issuechatuxlab.general.fixturebackedliverun")}</Badge>
            </div>

            <div className="mt-6 flex flex-wrap items-center gap-3">
              <Button variant="outline" size="sm" className="rounded-full" onClick={() => setShowComposer((value) => !value)}>
                {showComposer ? t("issuechatuxlab.general.hidecomposerinprimarypreview") : t("issuechatuxlab.general.showcomposerinprimarypreview")}
              </Button>
              <a
                href="#live-execution"
              ...
              >
                ...
                {t("issuechatuxlab.general.jumptoliveexecutionpreview")}</a>
            </div>
          </div>
          ...
          <aside className="border-t border-border/60 bg-background/70 p-6 lg:border-l lg:border-t-0">
            <div className="mb-4 flex items-center gap-2 text-(length:--text-micro) font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
              ...
              {t("issuechatuxlab.general.coveredstates")}</div>
      ...
      <LabSection
        ...
        title={t("issuechatuxlab.general.rotatingreasoningtext")}
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            <div className="mb-2 text-(length:--text-nano) font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
              {t("issuechatuxlab.general.defaultinterval22s")}</div>
            <RotatingReasoningDemo />
          </div>
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            <div className="mb-2 text-(length:--text-nano) font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
              {t("issuechatuxlab.general.fastinterval1sstresstest")}</div>
      ...
      <LabSection
        ...
        title={t("issuechatuxlab.general.workingworkedheaderverb")}
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            <div className="mb-3 text-(length:--text-nano) font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
              {t("issuechatuxlab.general.activerunshimmer")}</div>
            <div className="flex items-center gap-2.5 rounded-lg px-1 py-2">
              <span className="inline-flex items-center gap-2 text-sm font-medium text-foreground/80">
                <Loader2 className="h-4 w-4 shrink-0 animate-spin text-muted-foreground" />
                <span className="shimmer-text">{t("issuechatuxlab.general.working")}</span>
              </span>
              <span className="text-xs text-muted-foreground/60">{t("issuechatuxlab.general.for12s")}</span>
            </div>
          </div>
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            <div className="mb-3 text-(length:--text-nano) font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
              {t("issuechatuxlab.general.completedrunstatic")}</div>
            <div className="flex items-center gap-2.5 rounded-lg px-1 py-2">
              <span className="inline-flex items-center gap-2 text-sm font-medium text-foreground/80">
                <span className="flex h-4 w-4 shrink-0 items-center justify-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-500/70" />
                </span>
                {t("issuechatuxlab.general.worked")}</span>
              <span className="text-xs text-muted-foreground/60">{t("issuechatuxlab.general.for1min24s")}</span>
            </div>
          </div>
        </div>
      </LabSection>
      ...
      <LabSection
        ...
        title={t("issuechatuxlab.general.liveexecutionthread")}
      ...
      <LabSection
        ...
        title={t("issuechatuxlab.general.pendingmessagebubble")}
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <LabSection
          ...
          title={t("issuechatuxlab.general.durablecommentsandfeedback")}
        ...
        <div className="space-y-6">
          <LabSection
            ...
            title={t("issuechatuxlab.general.emptystateanddisabledcomposer")}
          ...
          <Card className="gap-4 border-border/70 bg-background/85 py-0">
            <CardHeader className="px-5 pt-5 pb-0">
              <div className="flex items-center gap-2 text-(length:--text-micro) font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
                ...
                {t("issuechatuxlab.general.reviewchecklist")}</div>
              <CardTitle className="text-lg">{t("issuechatuxlab.general.whattoevaluateonthispage")}</CardTitle>
              <CardDescription>
                {t("issuechatuxlab.general.thisrouteshouldbethefastestway")}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3 px-5 pb-5 pt-0 text-sm text-muted-foreground">
              <div className="rounded-2xl border border-border/70 bg-background/80 px-4 py-3">
                <div className="mb-1 flex items-center gap-2 font-medium text-foreground">
                  ...
                  {t("issuechatuxlab.general.messagehierarchy")}</div>
                {t("issuechatuxlab.general.checkthatuserassistantandsystemrows")}</div>
              <div className="rounded-2xl border border-border/70 bg-background/80 px-4 py-3">
                <div className="mb-1 flex items-center gap-2 font-medium text-foreground">
                  <Sparkles className="h-4 w-4 text-cyan-700 dark:text-cyan-300" />
                  {t("issuechatuxlab.general.streampolish")}</div>
                {t("issuechatuxlab.general.watchthelivepreviewforreasoningdensity")}</div>
            </CardContent>
          </Card>
        </div>
      </div>
