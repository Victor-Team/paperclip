...
export function Approvals() {
  ...
  if (!selectedCompanyId) {
    return <p className="text-sm text-muted-foreground">{t("approvals.general.selectanorganizationfirst")}</p>;
  }
      ...
      {filtered.length === 0 && (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            {statusFilter === "pending" ? t("approvals.general.nopendingapprovals") : t("approvals.general.noapprovalsyet")}
          </p>
        </div>
      )}
