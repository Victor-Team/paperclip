  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <Card className="block p-6">
        <h1 className="text-xl font-semibold">{t("cloudaccessgate.general.noorganizationaccess")}</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          {t("cloudaccessgate.general.thisaccountissignedinbutit")}</p>
        <p className="mt-2 text-sm text-muted-foreground">
          {t("cloudaccessgate.general.useanorganizationinviteorsignin")}</p>
      </Card>
    </div>
  );
}
      ...
      <div className="mx-auto max-w-xl py-10 text-sm text-destructive">
        {healthQuery.error instanceof Error
          ...
          : boardAccessQuery.error instanceof Error
            ...
            : t("cloudaccessgate.general.failedtoloadappstate")}
      </div>
    );
  }
