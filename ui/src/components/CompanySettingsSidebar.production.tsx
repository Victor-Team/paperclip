    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
      <div className="flex flex-col gap-1 px-3 py-3 shrink-0">
        ...
        >
          ...
          <span className="truncate">{selectedCompany?.name ?? t("companysettingssidebarproduction.general.company")}</span>
        </Link>
      </div>

      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide px-3 py-2">
        <div className="flex flex-col gap-0.5">
          <SidebarNavItem to="/company/settings" label={t("companysettingssidebarproduction.general.general")} icon={SlidersHorizontal} end />
          {showPage("instance.profile") && (
            <SidebarNavItem
              to={`${INSTANCE_SETTINGS_PATH_PREFIX}/profile`}
              label={t("companysettingssidebarproduction.general.profile")}
              icon={UserRoundPen}
              end
            />
          )}
          {showPage("company.members") && (
            <SidebarNavItem
              ...
              label={t("companysettingssidebarproduction.general.members")}
              icon={Users}
          ...
          {showPage("company.invites") && (
            <SidebarNavItem to="/company/settings/invites" label={t("companysettingssidebarproduction.general.invites")} icon={MailPlus} end />
          )}
          {showPage("company.secrets") && (
            <SidebarNavItem to="/company/settings/secrets" label={t("companysettingssidebarproduction.general.secrets")} icon={KeyRound} end />
          )}
          {showPage("instance.environments") && (
            <SidebarNavItem
              to={`${INSTANCE_SETTINGS_PATH_PREFIX}/environments`}
              label={t("companysettingssidebarproduction.general.environments")}
              icon={MonitorCog}
              end
            />
          )}
          {showPage("instance.access") && (
            <SidebarNavItem
              ...
              label={t("companysettingssidebarproduction.general.access")}
              icon={Shield}
              end
            />
          )}
          {showPage("instance.heartbeats") && (
            <SidebarNavItem
              ...
              label={t("companysettingssidebarproduction.general.heartbeats")}
              icon={Clock3}
              end
            />
          )}
          {showPage("company.export") && (
            <SidebarNavItem to="/company/export" label={t("companysettingssidebarproduction.general.export")} icon={Download} />
          )}
          {!isCloud && showPage("company.import") && (
            <SidebarNavItem to="/company/import" label={t("companysettingssidebarproduction.general.import")} icon={Upload} end />
          )}
          {showPage("instance.experimental") && (
            <SidebarNavItem
              to={`${INSTANCE_SETTINGS_PATH_PREFIX}/experimental`}
              label={t("companysettingssidebarproduction.general.experimental")}
              icon={FlaskConical}
            />
          )}
          {showPlugins && (
            <SidebarNavItem
              ...
              label={t("companysettingssidebarproduction.general.plugins")}
              icon={Puzzle}
            />
          )}
          ...
          {showPage("instance.adapters") && (
            <SidebarNavItem
              ...
              label={t("companysettingssidebarproduction.general.adapters")}
              icon={Cpu}
            />
          )}
        </div>
