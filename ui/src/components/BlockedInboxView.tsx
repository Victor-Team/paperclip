      ...
      >
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1 space-y-1">
            <p className="text-sm font-medium">{t("blockedinboxview.general.couldntloadtheblockedtab")}</p>
            <p className="text-xs opacity-80">
              {t("blockedinboxview.general.otherinboxtabsstillwork")} {message}
            </p>
          </div>
          <Button
            type="button"
            ...
            disabled={isFetching}
          >
            {isFetching ? t("blockedinboxview.general.trying") : t("blockedinboxview.general.tryagain")}
          </Button>
        </div>
      </div>
    );
    ...
    return (
      ...
      >
        ...
        <div className="space-y-1">
          <p className="text-sm font-medium text-foreground">{t("blockedinboxview.general.noworkisstopped")}</p>
          <p className="text-xs text-muted-foreground">
            {t("blockedinboxview.general.tasksthatneedadecisionrecoveryor")}</p>
        </div>
      </Card>
    );
  }
  ...
  if (groups.length === 0) {
    return (
      <div className="space-y-3">
        ...
        >
          {t("blockedinboxview.general.nostoppeditemsmatchyoursearch")}</Card>
      </div>
    );
  }
