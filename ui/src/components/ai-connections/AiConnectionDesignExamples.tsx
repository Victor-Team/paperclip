  ...
  return (
    <div className="flex max-w-2xl flex-col gap-5">
      <p className="text-sm text-muted-foreground">
        {t("aiconnectiondesignexamples.general.sharedaiconnectionidentityaccountselectionand")}</p>
      <p className="text-sm text-muted-foreground">{t("aiconnectiondesignexamples.general.providerlistsandaccountmanagementusebrowse")}</p>
      <AiConnectionPicker
      ...
      <ProviderApiKeyCard
        ...
        onChange={() => {}}
        onSubmit={() => {}}
        placeholder={t("aiconnectiondesignexamples.general.enterapikeyhere")}
      />
