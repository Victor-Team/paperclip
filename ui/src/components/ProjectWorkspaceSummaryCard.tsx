          ...
          <div className="min-w-0 space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Badge variant="outline" className="border-border/70 bg-background px-2.5 py-1 text-muted-foreground">
                {t("projectworkspacesummarycard.general.updated")} {timeAgo(summary.lastUpdatedAt)}
              </Badge>
              {summary.serviceCount > 0 ? (
                ...
                >
                  ...
                  />
                  {summary.runningServiceCount}/{summary.serviceCount} {t("projectworkspacesummarycard.general.services")}</Badge>
              ) : null}
          ...
          >
            {summary.hasRuntimeConfig ? (
              ...
              >
                ...
                {hasRunningServices ? t("projectworkspacesummarycard.general.stopservices") : t("projectworkspacesummarycard.general.startservices")}
              </Button>
            ) : null}
            {summary.kind === "execution_workspace" && summary.executionWorkspaceId && summary.executionWorkspaceStatus ? (
              ...
              >
                {summary.executionWorkspaceStatus === "cleanup_failed" ? t("projectworkspacesummarycard.general.retryclose") : t("projectworkspacesummarycard.general.closeworkspace")}
              </Button>
            ) : null}
          </div>
        </div>
            ...
            {summary.branchName ? (
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-(length:--text-micro) uppercase tracking-(--tracking-eyebrow) text-muted-foreground">{t("projectworkspacesummarycard.general.branch")}</div>
                  <div className="flex items-start gap-2">
                    <CopyText
            ...
            */}
            {summary.cwd && !hideHostPaths ? (
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-(length:--text-micro) uppercase tracking-(--tracking-eyebrow) text-muted-foreground">{t("projectworkspacesummarycard.general.path")}</div>
                  <div className="flex items-start gap-2">
                    <CopyText
                      text={summary.cwd}
                      title={summary.cwd}
            ...
            {summary.primaryServiceUrl ? (
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0">
                  <div className="text-(length:--text-micro) uppercase tracking-(--tracking-eyebrow) text-muted-foreground">{t("projectworkspacesummarycard.general.service")}</div>
                  <a
        ...
        {summary.issues.length > 0 ? (
          <div className="space-y-2">
            <div className="text-(length:--text-micro) font-medium uppercase tracking-(--tracking-eyebrow) text-muted-foreground">
              {t("projectworkspacesummarycard.general.linkedtasks")}</div>
            <div className="flex flex-wrap gap-2">
              ...
              {hiddenIssueCount > 0 ? (
                ...
                >
                  +{hiddenIssueCount} {t("projectworkspacesummarycard.general.more")}</Link>
              ) : null}
            </div>
          </div>
        ) : null}
