  ...
  override render() {
    ...
    return (
      <div className="mx-auto flex min-h-screen max-w-2xl flex-col justify-center space-y-4 px-4 py-10">
        <div>
          <h1 className="text-lg font-semibold">{t("apperrorboundary.general.papercliphitanerror")}</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            {t("apperrorboundary.general.somethingwentwrongwhilerunningtheapp")}
          </p>
        </div>
        ...
        <div>
          ...
          >
            {t("apperrorboundary.general.reloadpage")}
          </button>
        </div>
      </div>
    );
