...
export function RoutineSubSidebar({
  ...
  return (
    <nav
      aria-label={t("routinesubsidebar.general.routinesections")}
            ...
            return (
              ...
              >
                ...
                {showLiveDot ? (
                  ...
                  <span
                    aria-label={t("routinesubsidebar.general.unsavedchanges")}
...
export function RoutineSectionPicker({
  ...
  return (
    <div className="sticky top-0 z-10 border-b border-border bg-background px-4 py-2 md:hidden">
      ...
      >
        <SelectTrigger className="h-11 w-full" aria-label={t("routinesubsidebar.general.routinesection")}>
          <SelectValue />
        </SelectTrigger>
        <SelectContent>
          {NAV_GROUPS.map((group) => (
