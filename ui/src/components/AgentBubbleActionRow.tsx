      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            title={t("agentbubbleactionrow.general.moreactions")}
            aria-label={t("agentbubbleactionrow.general.moreactions1")}
          >
        ...
        <DropdownMenuContent align="end">
          ...
          >
            ...
            {t("agentbubbleactionrow.general.copymessage")}</DropdownMenuItem>
          {menuItems}
        </DropdownMenuContent>
      </DropdownMenu>
    </div>
  ...
  return (
    <>
      <button
        ...
        title={t("agentbubbleactionrow.general.helpful")}
        aria-label={t("agentbubbleactionrow.general.helpful2")}
      ...
      <Popover open={reasonOpen} onOpenChange={setReasonOpen}>
        <PopoverTrigger asChild>
          <button
            ...
            title={t("agentbubbleactionrow.general.needswork")}
            aria-label={t("agentbubbleactionrow.general.needswork3")}
        ...
        <PopoverContent side="top" align="start" className="w-80 p-3">
          <div className="mb-2 text-sm font-medium">{t("agentbubbleactionrow.general.whatcouldhavebeenbetter")}</div>
          <Textarea
            value={downvoteReason}
            onChange={(event) => setDownvoteReason(event.target.value)}
            placeholder={t("agentbubbleactionrow.general.addashortnote")}
          ...
          <div className="mt-2 flex items-center justify-end gap-2">
            ...
            >
              {t("agentbubbleactionrow.general.dismiss")}</Button>
            <Button
              type="button"
              size="sm"
            ...
            >
              {isSaving ? t("agentbubbleactionrow.general.saving") : t("agentbubbleactionrow.general.savenote")}
            </Button>
          </div>
        </PopoverContent>
      </Popover>
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("agentbubbleactionrow.general.saveyourfeedbacksharingpreference")}</DialogTitle>
            <DialogDescription>
              {t("agentbubbleactionrow.general.choosewhethervotedaioutputscanbe")}</DialogDescription>
          </DialogHeader>
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>{t("agentbubbleactionrow.general.thisvoteisalwayssavedlocally")}</p>
            <p>
              {t("agentbubbleactionrow.general.choose")}<span className="font-medium text-foreground">{t("agentbubbleactionrow.general.alwaysallow")}</span> {t("agentbubbleactionrow.general.tosharethisvoteandfuturevoted")}{" "}
              <span className="font-medium text-foreground">{t("agentbubbleactionrow.general.dontallow")}</span> {t("agentbubbleactionrow.general.tokeepthisvoteandfuturevotes")}</p>
            <p>{t("agentbubbleactionrow.general.youcanchangethislaterinsettings")}</p>
            {termsUrl ? (
              <a
                href={termsUrl}
                target="_blank"
              ...
              >
                {t("agentbubbleactionrow.general.readourtermsofservice")}</a>
            ) : null}
          </div>
          <DialogFooter>
            <Button
            ...
            >
              {isSaving ? t("agentbubbleactionrow.general.saving4") : t("agentbubbleactionrow.general.dontallow5")}
            </Button>
            <Button
              type="button"
              disabled={!pendingSharingDialog || isSaving}
            ...
            >
              {isSaving ? t("agentbubbleactionrow.general.saving6") : t("agentbubbleactionrow.general.alwaysallow7")}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
