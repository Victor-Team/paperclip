...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("mobilebottomnav.general.home"), icon: House },
      { type: "link", to: "/issues", label: t("mobilebottomnav.general.tasks"), icon: CircleCheck },
      { type: "action", label: t("mobilebottomnav.general.newTask"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("mobilebottomnav.general.agents"), icon: Users },
      {
        type: "link",
        to: "/inbox",
        label: t("mobilebottomnav.general.inbox"),
        icon: Inbox,
  ...
  return (
    <nav
      ...
      aria-label={t("mobilebottomnav.general.mobileNavigation")}
    >
