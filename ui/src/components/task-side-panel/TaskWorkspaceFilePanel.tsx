        ...
        <div className="flex shrink-0 items-center gap-1">
          {contentQuery.data ? (
            <Button
              ...
              variant="ghost"
              size="icon-sm"
              aria-label={t("taskworkspacefilepanel.general.copyfilecontents")}
              title={copied ? t("taskworkspacefilepanel.general.copied") : t("taskworkspacefilepanel.general.copyfilecontents")}
              onClick={() => {
          ...
          {downloadUrl ? (
            <Button asChild variant="ghost" size="icon-sm">
              <a href={downloadUrl} download={resource?.title} aria-label={t("taskworkspacefilepanel.general.downloadfile")} title={t("taskworkspacefilepanel.general.downloadfile1")}>
