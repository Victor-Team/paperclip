        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <CardDescription className="mt-1 text-xs">
              {row.eventCount} {t("financebillercard.general.event")}t{row.eventCount === 1 ? "" : t("financebillercard.general.s")} {t("financebillercard.general.across")} {row.kindCount} {t("financebillercard.general.kind")}{row.kindCount === 1 ? "" : t("financebillercard.general.s1")}
            </CardDescription>
          </div>
