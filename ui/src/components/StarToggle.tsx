...
export function StarToggle({
  ...
  const ariaLabel = starred
    ? t("startoggle.general.unstarResource", { resourceName })
    : t("startoggle.general.starResource", { resourceName });
  const retryTitle = error ? t("startoggle.general.retry") : undefined;
