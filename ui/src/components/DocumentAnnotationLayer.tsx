        ...
        <div ref={overlayRef} className="relative h-full w-full">
          {highlightRects.map((rect, index) => {
            ...
            return (
              <button
                ...
                data-focused={isFocused || undefined}
                data-hovered={isHovered || undefined}
                aria-label={t("documentannotationlayer.general.openannotationthread")}
                className={cn(
          ...
          {highlightRects.map((rect, index) =>
            rect.isTail && rect.anchorState === "stale" ? (
              <span
                ...
                title={t("documentannotationlayer.general.anchormovedneedsreview")}
              >
          ...
          {pendingAnchor && toolbarPosition ? (
            <div
              ...
              role="toolbar"
              aria-label={t("documentannotationlayer.general.selectionactions")}
            ...
            >
              ...
              >
                ...
                {t("documentannotationlayer.general.comment")}</Button>
            </div>
          ) : null}
        </div>
      </div>
