    ...
    <DropdownMenu open={menuOpen} onOpenChange={setMenuOpen}>
      <DropdownMenuTrigger asChild>
        <button
          ...
          aria-label={menu?.ariaLabel ?? t("sidebarsection.general.sectionActions", { label })}
        >
          {headerContent}
        </button>
      </DropdownMenuTrigger>
        ...
        {collapsible ? (
          <CollapsibleTrigger asChild>
            <button
              ...
              aria-label={collapsible.open ? t("sidebarsection.general.collapseSection", { label }) : t("sidebarsection.general.expandSection", { label })}
            >
