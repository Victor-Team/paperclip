  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen} className="overflow-hidden rounded-lg border border-border/70">
      <CollapsibleTrigger className="flex w-full items-center justify-between px-3 py-2 text-left">
        <div>
          <p className="text-sm font-medium">{t("routinevariableseditor.general.variables")}</p>
          <p className="text-xs text-muted-foreground">
            {t("routinevariableseditor.general.detectedfrom")}{t("routinevariableseditor.general.name")}{t("routinevariableseditor.general.placeholdersinthetitleandinstructions")}</p>
        </div>
          ...
          <div key={variable.name} className="p-4">
            <div className="mb-3 flex flex-wrap items-center gap-2">
              ...
              <span className="text-xs text-muted-foreground">
                {t("routinevariableseditor.general.prompttheuserforthisvaluebefore")}</span>
            </div>

            <div className="grid gap-3 md:grid-cols-2">
              <div className="space-y-1.5">
                <Label className="text-xs">{t("routinevariableseditor.general.label")}</Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label className="text-xs">{t("routinevariableseditor.general.type")}</Label>
                <Select
                  value={variable.type}
              ...
              <div className="space-y-1.5 md:col-span-2">
                <div className="flex items-center justify-between gap-3">
                  <Label className="text-xs">{t("routinevariableseditor.general.defaultvalue")}</Label>
                  <label className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    />
                    {t("routinevariableseditor.general.required")}</label>
                </div>
                ...
                {variable.type === "textarea" ? (
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="__unset__">{t("routinevariableseditor.general.nodefault")}</SelectItem>
                      <SelectItem value="true">{t("routinevariableseditor.general.true")}</SelectItem>
                      <SelectItem value="false">{t("routinevariableseditor.general.false")}</SelectItem>
                    </SelectContent>
                  </Select>
                ) : variable.type === "select" ? (
                  <div className="grid gap-3 md:grid-cols-2">
                    <div className="space-y-1.5">
                      <Label className="text-xs">{t("routinevariableseditor.general.options")}</Label>
                      <Input
                        ...
                        placeholder={t("routinevariableseditor.general.highmediumlow")}
                      />
                    </div>
                    <div className="space-y-1.5">
                      <Label className="text-xs">{t("routinevariableseditor.general.defaultoption")}</Label>
                      <Select
                      ...
                      >
                        <SelectTrigger>
                          <SelectValue placeholder={t("routinevariableseditor.general.nodefault1")} />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="__unset__">{t("routinevariableseditor.general.nodefault2")}</SelectItem>
  ...
  return (
    <>
      <div className="flex items-center justify-between gap-2 rounded-lg border border-dashed border-border/70 px-3 py-2 text-xs text-muted-foreground">
        <span>
          {t("routinevariableseditor.general.use")}{t("routinevariableseditor.general.variablename")}{t("routinevariableseditor.general.placeholdersinthetitleorinstructionsto")}</span>
        <button
          type="button"
          ...
          aria-label={t("routinevariableseditor.general.showvariablehelp")}
        >
      ...
      <Dialog open={helpOpen} onOpenChange={setHelpOpen}>
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            <DialogTitle>{t("routinevariableseditor.general.routinevariables")}</DialogTitle>
            <DialogDescription>
              {t("routinevariableseditor.general.howtopromptforinputsandwhich")}</DialogDescription>
          </DialogHeader>

          <div className="space-y-5 text-sm">
            <section className="space-y-2">
              <h3 className="text-xs font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
                {t("routinevariableseditor.general.customvariables")}</h3>
              <p className="text-muted-foreground">
                {t("routinevariableseditor.general.type3")}{" "}
                <code className="rounded bg-muted px-1 py-0.5 font-mono text-xs text-foreground">
                  {t("routinevariableseditor.general.variablename4")}
                </code>{" "}
                {t("routinevariableseditor.general.anywhereinthetitleorinstructionspaperclip")}<span className="font-medium text-foreground">{t("routinevariableseditor.general.variables5")}</span>{t("routinevariableseditor.general.andpromptsforavaluebeforeeach")}</p>
              <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
                <li>{t("routinevariableseditor.general.namesmuststartwithaletterand")}</li>
                <li>{t("routinevariableseditor.general.pickatypetexttextareanumberboolean")}</li>
                <li>{t("routinevariableseditor.general.variablenamesendingincapitaldatesuch")}</li>
                <li>{t("routinevariableseditor.general.thesamenamereusedacrossthetitle")}</li>
              </ul>
            </section>

            <section className="space-y-2">
              <h3 className="text-xs font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
                {t("routinevariableseditor.general.builtinvariables")}</h3>
              <p className="text-muted-foreground">
                {t("routinevariableseditor.general.thesearefilledinautomaticallynosetup")}</p>
              <div className="overflow-hidden rounded-lg border border-border/70">
                <table className="w-full text-left text-xs">
                  <thead className="bg-muted/40 text-muted-foreground">
                    <tr>
                      <th className="px-3 py-2 font-medium">{t("routinevariableseditor.general.placeholder")}</th>
                      <th className="px-3 py-2 font-medium">{t("routinevariableseditor.general.example")}</th>
                      <th className="px-3 py-2 font-medium">{t("routinevariableseditor.general.description")}</th>
                    </tr>
                  </thead>
