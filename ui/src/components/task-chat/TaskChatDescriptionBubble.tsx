    ...
    return (
      ...
      >
        <InlineEditor
          ...
          placeholder={t("taskchatdescriptionbubble.general.addadescription")}
          multiline
          defaultEditing
  ...
  if (!hasDescription) {
    ...
    return (
      ...
      >
        ...
        {t("taskchatdescriptionbubble.general.addadescription1")}</button>
    );
  }
      ...
      >
        ...
        {!isHuman ? (
          <button
            ...
            onClick={() => setEditing(true)}
            aria-label={t("taskchatdescriptionbubble.general.editdescription")}
