  ...
  return (
    <div className="flex flex-col gap-2 py-2">
      <div className="flex items-center gap-2 px-1 text-xs text-muted-foreground">
        <span className="font-medium text-foreground">{t("taskchatplanview.general.plan")}</span>
        <span>{t("taskchatplanview.general.rev")} {plan.revision}</span>
        <span className="ml-auto">
          {done}/{plan.entries.length} {t("taskchatplanview.general.done")}</span>
      </div>
